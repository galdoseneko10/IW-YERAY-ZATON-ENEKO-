...
urlpatterns = [
    ...
    path('componentes/', views.ProductosListView.as_view(), name='componentes'),
    path('componente/<int:pk>/', views.ProductoDetailView.as_view(), name='componente'),
    path('componente/create/', views.CreateProductoView.as_view(), name='componente_create'),
    path('componentes/delete/<int:componente_id>/', views.delete_producto, name='componente_delete'),
    path('componentes/edit/<int:componente_id>/', views.edit_producto, name='componente_edit'),
]
